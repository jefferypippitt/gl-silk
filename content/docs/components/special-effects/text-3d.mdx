...
<SectionHeader title="Default" name="text-3d" />
...
<Tab value="Code">
<CodeBlockWithAction name="text-3d">
...
<SectionHeader title="Gradient" name="text-3d-gradient" />
...
<Tab value="Code">
<CodeBlockWithAction name="text-3d-gradient">
...
<SectionHeader title="Advanced Playground" name="text-3d-advanced" />
...
<Tab value="Code">
<CodeBlockWithAction name="text-3d-advanced">
