...
<SectionHeader title="Default" name="theme-toggle-button" />
...
<Tab value="Code">
<CodeBlockWithAction name="theme-toggle-button">
...
<SectionHeader title="Rounded" name="theme-toggle-button-rounded" />
...
<Tab value="Code">
<CodeBlockWithAction name="theme-toggle-button-rounded">
...
<SectionHeader title="Custom Colors" name="theme-toggle-button-colored" />
...
<Tab value="Code">
<CodeBlockWithAction name="theme-toggle-button-colored">
...
<SectionHeader title="Dual Color Mode" name="theme-toggle-button-dual-color" />
...
<Tab value="Code">
<CodeBlockWithAction name="theme-toggle-button-dual-color">
