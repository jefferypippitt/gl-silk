...
<SectionHeader title="Custom Styling Example" name="split-text-custom-styling" previewId="split-text-custom-styling" />
...
<Tab value="Code">
<CodeBlockWithAction name="split-text-custom-styling" previewId="split-text-custom-styling">
