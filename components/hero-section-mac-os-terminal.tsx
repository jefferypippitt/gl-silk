...
const HERO_STEPS: TerminalStep[] = [
  ...
  { type: "output", text: "  - app/hero-section-v1/page.tsx" },
  { type: "output", text: "  - app/hero-section-v1/hero-section-v1.tsx" },
  { type: "output", text: "  - app/hero-section-v1/hero-section-v1.css" },
