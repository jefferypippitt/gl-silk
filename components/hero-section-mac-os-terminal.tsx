...
const HERO_STEPS: TerminalStep[] = [
  ...
  { type: "blank", text: "" },
  { type: "output", text: "√ Created 6 files:" },
  { type: "output", text: "  - app\\glsilk\\hero-section-v1\\page.tsx" },
  { type: "output", text: "  - app\\glsilk\\hero-section-v1\\hero-section-v1.tsx" },
  { type: "output", text: "  - app\\glsilk\\hero-section-v1\\hero-section-v1.css" },
  { type: "output", text: "  - app\\glsilk\\hero-section-v1\\button.tsx" },
  { type: "output", text: "  - app\\glsilk\\hero-section-v1\\utils.ts" },
  { type: "output", text: "  - public\\images\\super-fast-api.webp" },
  { type: "blank", text: "" },
